	...
	<div style="text-align: center">
		...
		<form action="ChangeInformationServlet" method="post">
			<table border="1" style="width: 100%">
				...
				<tr>
					<td>Can't change</td>
					<td><input type="number" step="any" name="balance"
						placeholder="Subtract balance"></td>
					...
					<td><input type="number" step="any" name="debt"
						placeholder="Add/subtract debt"></td>
					<td><input type="number" step="any" name="interest"
						placeholder="New interest"></td>
					<td><input type="text" name="cusid" placeholder="New owner">
					</td>
				</tr>
				<%
					}
			...
			<input type="hidden" name="accid"
				value="<%=account.getAccountID().toString()%>"> <input
				type="submit" name="changeinformation">
		</form>
	</div>
</body>
</html>